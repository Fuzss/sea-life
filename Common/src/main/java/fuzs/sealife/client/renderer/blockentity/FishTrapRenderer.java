...
public class FishTrapRenderer implements BlockEntityRenderer<FishTrapBlockEntity> {
    ...
    public static final RenderType RENDER_TYPE = RenderType.text(GUI_SHEET);
    private static final ResourceLocation SPEECH_BUBBLE_SPRITE = SeaLife.id("speech_bubble");
    ...
    @Override
    public void render(FishTrapBlockEntity blockEntity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
