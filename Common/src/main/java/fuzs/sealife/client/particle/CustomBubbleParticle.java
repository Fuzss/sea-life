...
public class CustomBubbleParticle extends BubbleParticle {
    ...
    public CustomBubbleParticle(ClientLevel clientLevel, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            CustomBubbleParticle bubbleParticle = new CustomBubbleParticle(level, x, y, z, xSpeed, ySpeed, zSpeed);
